...
A desktop agent is an AI that has its own computer. Unlike browser-only agents or traditional RPA tools, TARS comes with a full virtual desktop where it can:
...
Give TARS a task like "Download all invoices from our vendor portals and organize them into a folder" and it will:
...
Upload files directly to TARS's desktop and it can:
...
TARS isn't limited to web interfaces. It can:
...
TARS consists of four integrated components:
...
3. **Task Interface**: Web UI where you create tasks and watch TARS work
...
- **File Uploads**: Drop files onto tasks for TARS to process
- **Live Desktop View**: Watch TARS work in real-time
...
Use one of the deployment methods above to get TARS running.
...
- Log into websites you want TARS to access

### 3. Start Giving Tasks

Create tasks in natural language and watch TARS complete them using the configured desktop.
...
TARS is open source under the Apache 2.0 license.
