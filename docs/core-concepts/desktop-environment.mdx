...
description: "The virtual Linux desktop where TARS performs tasks"
---

## Overview

The TARS Desktop Environment (also called TARS Core) is a complete Linux desktop that runs in a Docker container. This is where TARS does its work - clicking buttons, typing text, browsing websites, and using applications just like you would.

<img
  src="/images/core-container.png"
  alt="TARS Desktop Environment"
...
```dockerfile
FROM ghcr.io/magellax/tars-desktop:edge
