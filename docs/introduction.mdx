...
<p align="center">
  <img
    ...
    src="/logo/tars_transparent_logo_dark.png"
    alt="TARS Logo"
    width="500"
  />
  <img
    className="hidden dark:block"
    src="/logo/tars_transparent_logo_white.png"
    alt="TARS Logo"
    width="500"
  />
</p>
...
TARS is an open-source AI agent that can control a computer desktop to complete tasks for you. It runs in Docker containers on your own infrastructure, giving you a virtual assistant that can:
...
Simply describe what you need done in plain English, and TARS will figure out how to do it – clicking buttons, typing text, navigating websites, reading documents, and completing tasks just like a human would.

## Why TARS Over Traditional RPA?
...
<CardGroup cols={2}>
  ...
  <Card title="Adaptive Intelligence" icon="brain">
    AI-powered understanding means TARS adapts to UI changes without breaking
  </Card>
...
TARS is the next generation of RPA (Robotic Process Automation). It handles the same complex workflows as traditional tools like UiPath, but with AI-powered adaptability and automatic authentication:
...
TARS becomes even more powerful when combined with coding agents:

- **Full-Stack Testing**: Use a coding agent to generate code, then have TARS visually test and validate the output
- **Automated Debugging**: Let TARS reproduce user-reported issues while a coding agent analyzes and fixes the code
- **End-to-End Development**: Code agents write features, TARS tests them, creating a complete development loop
...
<Steps>
  <Step title="Describe Your Task">
    Simply tell TARS what you want done in natural language through the tasks
    interface
  </Step>
  <Step title="AI Plans the Actions">
    TARS understands your request and breaks it down into specific computer
    actions
  </Step>
  <Step title="Executes Actions">
    TARS executes the task on its virtual desktop using the keyboard
    and mouse
  </Step>
...
TARS consists of four integrated components working together:

<img src="/images/agent-architecture.png" alt="TARS Agent Architecture" />
...
<CardGroup cols={2}>
  ...
  >
    Ubuntu 22.04 with XFCE4, VSCode, Firefox, Thunderbird email client, and automation daemon (tarsd)
  </Card>
...
Just tell TARS what you need done. No coding or complex automation tools required.

### 🖥️ Full Desktop Access
TARS can use any application you can install - browsers, office tools, custom software.

### 🔒 Complete Privacy
Runs entirely on your infrastructure. Your data never leaves your servers.

### 🔄 Two Operating Modes
- **Autonomous Mode**: TARS completes tasks independently
...
- **Task View**: Watch and interact with TARS during task execution
...
<CardGroup cols={2}>
  ...
  <Card
    title="GitHub"
    icon="github"
    href="https://github.com/MagellaX/TARSBOT"
  >
