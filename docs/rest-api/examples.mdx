...
description: "Code examples for common automation scenarios using the TARS REST API"
---

This page provides practical examples of how to use the TARS REST API in different programming languages and scenarios.
...
async function fillForm() {
  ...
  await controlComputer("type_text", {
    text: "This is an automated message sent using TARS's Computer Use API",
    delay: 30,
  });
...
You can create a reusable automation framework with TARS:
...
class TARSDriver:
    """A Selenium-like driver for TARS"""
