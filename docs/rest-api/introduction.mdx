---
title: "Introduction"
description: "Overview of the TARS REST API"
---

## TARS REST API

TARS's core functionality is exposed through its REST API, which provides endpoints for interacting with the desktop environment. The API allows for programmatic control of mouse movement, keyboard input, and screen capture.
...
The TARS API does not require authentication by default when accessed locally. For remote access, standard network security practices should be implemented.
