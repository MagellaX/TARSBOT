...
description: "Code examples for common automation scenarios using the TARS API"
---
...
await controlComputer("click_mouse", { button: "left" });
    ...
    await controlComputer("type_text", {
      text: "This is an automated test using Node.js and TARS",
      delay: 30
    });
...
# Write a text file
result = write_file("/home/user/hello.txt", "Hello, TARS!")
...
TARS can serve as an alternative to Selenium for web testing:
