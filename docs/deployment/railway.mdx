...
| ---------------- | -------------------------------------------------------------------- | ---- | -------- | ------------------------------------ |
| **tars-ui**   | `ghcr.io/tars-ai/tars-ui:edge`                                 | 9992 | **Yes**  | Next.js web UI rendered to the world |
| **tars-agent**| `ghcr.io/tars-ai/tars-agent:edge`                              | 9991 | No       | Task orchestration & LLM calls       |
| **tars-desktop**| `ghcr.io/tars-ai/tars-desktop:edge`                          | 9990 | No       | Containerised Ubuntu + XFCE desktop  |
