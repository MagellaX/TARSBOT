...
export const TaskItem: React.FC<TaskItemProps> = ({ task }) => {
  ...
  return (
    <Link href={`/tasks/${task.id}`} className="block">
      <div className="bg-tars-bronze-light-2 border-tars-bronze-light-7 hover:bg-tars-bronze-light-3 flex min-h-24 items-start rounded-lg border p-5 transition-colors">
        <div className="mb-0.5 flex-1 space-y-2">
          ...
          <div className="ml-7 flex items-center justify-start space-x-1.5 text-xs">
            <span className="text-tars-bronze-light-10">
