...
export function Header() {
  ...
  const getLinkClasses = (path: string) => {
    ...
    const activeClasses =
      "bg-tars-bronze-light-a3 text-tars-bronze-light-12";
    const inactiveClasses =
      "text-tars-bronze-dark-9 hover:bg-tars-bronze-light-a1 hover:text-tars-bronze-light-12";
  ...
  return (
    <header className="bg-background flex items-center justify-between border-b p-4">
      <div className="flex items-center gap-6">
        ...
        <div>
          {mounted ? (
            <Image
              src={
                resolvedTheme === "dark"
                  ? "/tars_transparent_logo_white.png"
                  : "/tars_transparent_logo_dark.png"
              }
              alt="TARS Logo"
              width={100}
              height={30}
        ...
        <div className="border-tars-bronze-dark-11 h-5 border border-l-[0.5px]"></div>
        <div className="flex items-center gap-2">
          ...
          <Link
            href="https://docs.tars.ai/quickstart"
            target="_blank"
            rel="noopener noreferrer"
            className={getLinkClasses("https://docs.tars.ai")}
          >
