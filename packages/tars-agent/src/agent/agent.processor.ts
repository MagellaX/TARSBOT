...
export class AgentProcessor {
  ...
  private services: Record<string, TARSAgentService> = {};
  ...
  private async runIteration(taskId: string): Promise<void> {
    ...
    try {
      ...
      const model = task.model as unknown as TARSAgentModel;
      let agentResponse: TARSAgentResponse;
      ...
      if (error?.name === 'TARSAgentInterrupt') {
